...
def render_sidebar(df: pd.DataFrame) -> dict[str, Any]:
    ...
    """
    with st.sidebar:
        # Header — inline SVG logo + brand title
        st.markdown(
            """
<a href="https://bleviet.github.io/gitlab-pulse/" style="display:flex;align-items:center;gap:10px;margin-bottom:2px;text-decoration:none;color:inherit;">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="38" height="38"
       style="flex-shrink:0;border-radius:9px;" aria-hidden="true">
    <defs>
    ...
    <rect width="48" height="48" rx="13" fill="url(#gi-bg)" filter="url(#gi-sh)"/>
    <rect x="7"  y="31" width="7" height="11" rx="2.5" fill="white" opacity="0.90"/>
    <rect x="17" y="23" width="7" height="19" rx="2.5" fill="white" opacity="0.90"/>
    <rect x="27" y="15" width="7" height="27" rx="2.5" fill="white" opacity="0.90"/>
    <circle cx="38.5" cy="10.5" r="5.5" fill="none"
            stroke="white" stroke-width="2.4" opacity="0.95"/>
    <circle cx="38.5" cy="10.5" r="1.6" fill="white" opacity="0.80"/>
    <line x1="42.5" y1="14.5" x2="45" y2="17"
          stroke="white" stroke-width="2.4" stroke-linecap="round" opacity="0.95"/>
  </svg>
  <h1 style="font-size:1.35rem;margin:0;font-family:'Space Grotesk',sans-serif;
             font-weight:700;line-height:1.15;">
    <span style="color:#ff512f;">GitLab</span>Pulse
  </h1>
</a>
""",
