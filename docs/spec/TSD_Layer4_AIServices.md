...
GitLab Pulse treats AI summaries and issue chats as persistent local artifacts rather than temporary UI state. Each issue can accumulate a saved summary and chat history under `data/ai/`.
