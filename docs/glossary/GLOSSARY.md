...
Definitions of key architectural patterns and terms used in GitLab Pulse.
...
### **Implementation in GitLab Pulse**

We adapt this pattern to our tiered data storage strategy:

| Medallion Layer | GitLab Pulse Layer | Directory | Purpose |
| :--- | :--- | :--- | :--- |
