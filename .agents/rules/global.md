...
- Use a plain, technical, and honest tone across the entire repo. 
- Avoid marketing language, vague claims, and buzzwords; write documentation the way an engineer would explain the system to another engineer. 
- Prefer simple words over impressive words. 
- Do not exaggerate value; let the functionality speak for itself.
...
### 4. Developer Guides
Before implementing, consult `docs/guidelines/GUIDE_Developer.md` for coding standards, design patterns, and best practices specific to this project.